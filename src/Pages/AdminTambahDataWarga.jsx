...
const AdminTambahDataWarga = () => {
    ...
    const saveWarga = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`http://localhost:5000/datakeluarga/${id_keluarga}/warga`, {
                nama,
                usia,
                jk,
                posisi,
    ...
    const handleSubmitButtonClick = () => {
        Swal.fire({
            icon: 'success',
            title: 'Data Anggota Keluarga Berhasil Dibuat !',
        })
    }
    ...
    return (
        <div className='m-0 p-0'>
            {/* Topbar */}
            <Topbar className='z-50'>Tambah Data Anggota Keluarga</Topbar>
...
export default AdminTambahDataWarga